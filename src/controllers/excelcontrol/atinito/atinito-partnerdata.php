...
// Ensure caller intended ATINITO processing
$company = isset($_POST['company']) ? (string) $_POST['company'] : '';
$atinitoAliases = ['ATINITO'];
if(!in_array(strtoupper(trim($company)), $atinitoAliases, true)){
    echo json_encode(['success'=>false,'error'=>'Partner extractor only allowed for ATINITO']);
    exit;
}
