<?php
// bankofcommerce-partnerdata.php
...
// Ensure caller intended BANKOFCOMMERCE processing
$company = isset($_POST['company']) ? (string) $_POST['company'] : '';
$bankofcommerceAliases = ['BANKOFCOMMERCE'];
if(!in_array(strtoupper(trim($company)), $bankofcommerceAliases, true)){
    echo json_encode(['success'=>false,'error'=>'Partner extractor only allowed for BANKOFCOMMERCE']);
    exit;
}
