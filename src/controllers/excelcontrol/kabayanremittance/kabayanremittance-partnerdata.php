<?php
// kabayanremittance-partnerdata.php
...
// Ensure caller intended KabayanRemittance processing
$company = isset($_POST['company']) ? (string) $_POST['company'] : '';
$aliases = ['KABAYANREMITTANCE', 'KABAYAN REMITTANCE', 'KABAYAN'];
if(!in_array(strtoupper(trim($company)), $aliases, true)){
    echo json_encode(['success'=>false,'error'=>'Partner extractor only allowed for KabayanRemittance']);
    exit;
}
