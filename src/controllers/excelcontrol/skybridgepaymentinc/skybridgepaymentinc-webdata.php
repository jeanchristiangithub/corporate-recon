<?php
// skybridgepaymentinc-webdata.php
...
use PhpOffice\PhpSpreadsheet\Shared\Date as ExcelDate;
 ...
 try{
    ...
    // required columns - reuse MBTC expected headers (SkyBridge shares core format)
    $required = [
    ...
    // search the first 12 rows for a header row
    $headers = [];
    $headerRow = null;
