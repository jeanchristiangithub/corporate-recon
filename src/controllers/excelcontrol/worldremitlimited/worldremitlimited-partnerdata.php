<?php
// worldremitlimited-partnerdata.php
...
// Ensure caller intended WorldRemitLimited processing
$company = isset($_POST['company']) ? (string) $_POST['company'] : '';
$aliases = ['WORLDREMIT', 'WORLDREMITLIMITED', 'WORLDREMIT LIMITED', 'WORLDREMIT LTD'];
if(!in_array(strtoupper(trim($company)), $aliases, true)){
    echo json_encode(['success'=>false,'error'=>'Partner extractor only allowed for WorldRemitLimited']);
    exit;
}
